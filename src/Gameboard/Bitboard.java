...
public class Bitboard implements GameBoard{
    ...
    /**
     * Erzeugt aus einem Array von möglichen Spielzügen und dem ziehenden
     * Spieler ein Array der darausfolgenen {@link Bitboards}.
     * Die Züge werden nicht auf Gültigkeit geprüft. Liefert kein sinnvolles
     * Ergebnis für illegale Züge.
     * 
     * @param player
     *            der ziehende Spieler.
     * @param moves
     *            ein Array aller möglichen Züge.
     * @return
     */
    ...
    /**
     * Konvertiert {@code coord} in die Bitboard-Repräsentation als long
     * Variable.
     * 
     * @param coord
    ...
    /**
     * Konvertiert eine Koordinate in Bitboard-Repräsentation zurück in ein
     * {@link Coordinates} Objekt.
     * 
     * @param coord
    ...
    /**
     * Markiert die benachbarten Felder aller Bits in bitboard in einem neuen
     * Bitboard.
     * 
     * @param bitboard
     *            das Bitboard, von welchem die Nachbarn berechnet werden
     *            sollen.
     ...
     * 
     * @param changedfields
     *            Die Felder, welche sich durch den Zug geändert haben als long.
     * @param coord
     *            Die Koordinate des Zuges
     * @param player
     *            der Spieler, welcher den Zug ausgeführt hatte.
     */
    ...
    /**
     * Konvertiert ein {@code GameBoard} in ein {@code Bitboard}. Diese Methode
     * ist sparsam einzusetzen, da sie jedes Spielfeld einzeln abfragen muss.
     * 
     * @param gb
     *            Das umzuwandelne {@link GameBoard}
    ...
    /**
     * @param player
     *            der ziehende Spieler. Verwende {@code true} für rot oder
     *            {@code false} für grün.
     * @return gibt die Bitboard-Repräsentation aller möglichen Züge zurück.
     *         Sind keine Züge möglich, wird 0 zurück gegeben.
     */
    ...
    /**
     * 
     * @return {@code true} wenn das Spiel entschieden ist. Ansonsten
     *         {@code false}.
     */
     ...
     * Es wird nicht überprüft, ob der angegeben Zug legal ist. Der Zobrist-Hash
     ...
     *            {@code false} für grün.
     * @param coord
     *            die Bitboard-Repräsentation des Zuges.
     * @return die Bitmaske aller umgedrehter Steine. Kann verwendet werden um
     *         den Zug rückgängig zu machen oder um inkrementelle Hashes zu
     *         berechnen.
     */
    ...
    public final static long getflippedDiskRedHash(long red, long green, final long coord){
        ...
        hash2 ^= zobristrandomgreen[index] ^ zobristrandomred[index];
        return changedfields;
    }
    ...
    /**
     * Führ den angegebenen Zug auf einer Kopie von {@code this} aus. Der
     * Zobrist Hash wird dabei aktualisiert. Wird dieser für kein von diesem
     * Objekt stammendes {@code Bitboard} benötigt,
     * sollte aus Performancegründen die Methode
     ...
     *         {@code Bitboards, auf welchem der angegebene Zug ausgeführt wurde}
     */
