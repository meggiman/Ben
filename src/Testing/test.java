...
public class test{
    ...
    public static void main(String[] args){
        ...
        System.out.println(EndgameSearch.nodeCount);
        int outcometrue = EndgameSearch.outCome;

        TestArena testArena = new TestArena(new TestablePlayers.PlayerA(), new TestablePlayers.PlayerB(), 300);
