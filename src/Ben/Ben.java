/*********************************************************************************************/
/** Authors:                                                                                **/
/**     Manuel Eggimann (meggimann@student.ethz.ch)                                         **/
/**     Noah Huesser (nhuesser@student.ethz.ch)                                             **/
/**                                                                                         **/
/** This program was written with the help of the internet.                                 **/
/** Most of our knowledge was aquired on:                                                   **/
/**     http://chessprogramming.wikispaces.com                                              **/
/**     http://redalt.com/working-in-reversi-part-3                                         **/
/** Furthermore we analyzed the code of past winners (namely Xiaolong and glhf.GG),         **/
/** took some useful code and modified it for our use. Namely this is in the eval           **/
/** to figure out the stable disks, as well as some weighting of the different features     **/
/** Every piece of code we used from other sources than our own mind is well understood     **/
/** and used with the thought that it is the best solution!                                 **/
/**                                                                                         **/
/*********************************************************************************************/
package Ben;
...
public class Ben implements ITestablePlayer{
    ...
    private static final byte   maskC              = 0b01000010;
    private static final byte   maskA              = 0b00100100;
    private static final byte   maskB              = 0b00011000;

    // Corners, C-pieces, z-pieces, edges w/o corner or c-pieces, other pieces
    private static final long[] scoreCategories    = { 0x8100000000000081L, 0x4281000000008142L, 0x0024000000002400L, 0x3c0081818181003cL, 0x003c5a7e7e5a3c00L };
    private static final int[]  squareScoreWeight  = { 96, -3, -5, 2, -2 };
    ...
    // used to calculate stable pieces
    private static final long   LINES15[]          = {
                                                   0x0101010101010101L, 0x0202020202020202L, 0x0404040404040404L, 0x0808080808080808L,
                                                   0x1010101010101010L, 0x2020202020202020L, 0x4040404040404040L, 0x8080808080808080L
                                                   };
    private static final long   LINES37[]          = {
    ...
    private static final long   LINES04[]          = {
    ...
    private static final long   LINES26[]          = {
    ...
    // Help from Xiaolong and glhf.GG
    private static final short evaluate(long red, long green, long possibleMovesRedLong, long possibleMovesGreenLong){
        ...
        return (short) ((((red | green) & scoreCategories[0]) == 0 ? (Long.bitCount(red) < 2 ? -30 : 0)
    ...
    // Taken from Xiaolong
    private static final long getStableDisks(final long red, final long green){
